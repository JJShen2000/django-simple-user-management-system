...
import user_management_system.config
...
SECRET_KEY = 'django-insecure-ep07b1p^^0bb*yt(qa=+9t5al__8gu19$59ld)e(@))n-e$q^_'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'user_django',
        'USER': 'root',
        'PASSWORD': user_management_system.config.password,
        'HOST': '127.0.0.1',
        'PORT': 3306
    }
}
